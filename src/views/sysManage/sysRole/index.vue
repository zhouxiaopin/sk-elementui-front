<template>
    <div class="SysRole view-area">
        ...
        <!--修改-->
<!--        <update v-if="this.uptConf.visible" :conf="uptConf" :refreshData="requestQuery" @close="visible => this.uptConf.visible = visible"/>-->
...
<script>
    ...
    const idKey = 'roleId';
    //权限前缀
    const PERM_PREFIX = 'sysRole:';
    //api模块名
    const API_MODEL_NAME = 'SysRole';
    export default {
        name: "SysRole",
        components:{
            Add,
        ...
        data(){
            return{
                ...
                queryCondition:{
                    start:0,//当前第几页
                    length:10,//页面显示数量
                    cdtCustom:{roleFlag:null,roleName:null}
                },
                tableData:[],
                pageInfo:{},
                // loading:true
        ...
        methods: {
            ...
            requestQuery() {
                this.loading = true;
                this.$api.SysRole.query(this.queryCondition).then((res) => {
